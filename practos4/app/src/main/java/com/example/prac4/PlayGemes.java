...
public class PlayGemes extends AppCompatActivity {
    ...
    public void clcRestart(View view){
        ...
        button4.setBackgroundColor(button4.getContext().getResources().getColor(R.color.blue));
        button5.setBackgroundColor(button5.getContext().getResources().getColor(R.color.purpblack));
        button6.setBackgroundColor(button6.getContext().getResources().getColor(R.color.yellow));
        button7.setBackgroundColor(button7.getContext().getResources().getColor(R.color.zarya));
        button8.setBackgroundColor(button8.getContext().getResources().getColor(R.color.siz));
        button9.setBackgroundColor(button9.getContext().getResources().getColor(R.color.krich));
        button10.setBackgroundColor(button10.getContext().getResources().getColor(R.color.malachit));
        button11.setBackgroundColor(button11.getContext().getResources().getColor(R.color.yad));
    }
}
